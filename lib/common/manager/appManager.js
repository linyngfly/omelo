...
let logger = require('omelo-logger').getLogger('pomelo', __filename);
let transactionLogger = require('omelo-logger').getLogger('transaction-log', __filename);
let transactionErrorLogger = require('omelo-logger').getLogger('transaction-error-log', __filename);
