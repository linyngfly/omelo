...
module.exports = function(app, opts) {
  ...
  if (app.enabled('rpcDebugLog')) {
    ...
    opts.rpcLogger = require('omelo-logger').getLogger('rpc-debug', __filename);
  }
...
pro.start = function(cb) {
  if(this.opts.enableRpcLog) {
    logger.warn('enableRpcLog is deprecated in 0.8.0, please use app.rpcFilter(omelo.rpcFilters.rpcLog())');
  }
