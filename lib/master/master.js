...
const logger = require('omelo-logger').getLogger('pomelo', __filename);
const crashLogger = require('omelo-logger').getLogger('crash-log', __filename);
const adminLogger = require('omelo-logger').getLogger('admin-log', __filename);
const admin = require('omelo-admin');
